...
@section('content')
    ...
    <div class="max-w-screen-lg mx-auto px-4 py-12">
        ...
        <div class="max-w-screen-lg mx-auto">
            ...
            <div class="mb-6">
                <h1 class="text-lg font-semibold mb-1">Looking for Passco?</h1>
                <p>You can search by typing the course title, course code or examiner name.</p>
            </div>

            <div class="">


                <form action="{{ route('papers.search') }}" method="post" id="searchForm">
